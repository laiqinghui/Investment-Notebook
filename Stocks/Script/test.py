...
keyratios = pd.read_csv(data, index_col=0, skiprows=2, na_values='')
print(keyratios)
#
...
#     df = pd.io.excel.read_excel(fh,  index_col=0)
# print(df)

#     with open('% s.xls'%types, 'wb') as f:
...
# data = StringIO(response.text)
# keyratios = pd.read_csv(data, index_col=0, skiprows=2, header=0, na_values = '', skip_blank_lines=False )